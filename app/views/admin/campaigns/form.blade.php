...
@if(isset($item->id))     
	{{ Form::open(array('url' => 'admin/campaigns/edit', 'class'=>'form-horizontal', 'role'=>'form', 'files' => true)) }}
@else
	{{ Form::open(array('url' => 'admin/campaigns/create', 'class'=>'form-horizontal', 'role'=>'form', 'files' => true)) }}
@endif
     	...
     	<div class="form-group">
			...
			<div class="col-xs-4">
	            <?php  if(!empty($item->image)){ ?> 
	            	{{HTML::image('public/upload/'.$file.'/'.$item->image,'',array('width'=>'360px','height'=>'200px','id'=>'image_campaigns'))}} 
		...
		<div class="form-group">
			...
			<div class="col-xs-4">
				...
				{{ HTML::decode(HTML::link('admin/campaigns/', '<i class="glyphicon glyphicon-circle-arrow-left"></i> Back', array('class' => 'btn btn-success'))); }}
